...
class PatientInfo(models.Model):
    ...
    # Dental Health
    dental_health = models.CharField(max_length=10, choices=[('Good', 'Good'), ('Fair', 'Fair'), ('Poor', 'Poor')])
    dental_nervousness = models.CharField(max_length=10, choices=[('No', 'No'), ('Slightly', 'Slightly'), ('Moderately', 'Moderately'), ('Extremely', 'Extremely')])
    pregnancy_status = models.CharField(max_length=3, choices=[('yes', 'Yes'), ('no', 'No')])
    teeth_extracted = models.CharField(max_length=3, choices=[('yes', 'Yes'), ('no', 'No')])
    complications_after_extraction = models.CharField(max_length=3, choices=[('yes', 'Yes'), ('no', 'No')])
